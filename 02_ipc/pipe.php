...
// Unix socket pair (stream_socket_pair) — пара соединённых сокетов.
//
// ВАЖНО: это НЕ классический pipe(). Разница:
//   pipe()         — однонаправленный (read-конец + write-конец), системный вызов
//   socket_pair    — двунаправленный (оба конца читают И пишут)
// В PHP встроенной поддержки pipe() нет, поэтому используем stream_socket_pair.
//
